...
> Dad-Jokes is a website created with HTML, SCSS, and TypeScript. It utilizes an API to fetch jokes each time a user clicks a button. Linters are employed to overcome code errors and ensure a clean project. Please check out the live demo!
...
- [Live Demo Link](https://ameer2000mzori.github.io/Dad-Jokes/src/)
